...
namespace CSE445Assignment3_4
{
    public class MainClass
    {
        ...
        public static Semaphore _priceCutEventPool;
        ...
        public static void Main(string[] args)
        {
            ...
            _priceCutEventPool = new Semaphore(0, 5);                   // the saleEventPool semaphore will be used to notify all 5 threads of a priceCut
